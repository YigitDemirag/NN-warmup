import RL
from RL.utils.run_utils import ExperimentGrid
...
if __name__ == '__main__':
    ...
    if cmd in valid_help:
        ...
        special_info = dedent("""
            ...
            \tpython -m RL.run ppo --env HalfCheetah-v2 --clip_ratio 0.1

            If you need a quick refresher on valid kwargs, get the docstring
            with

            \tpython -m RL.run [algo] --help
